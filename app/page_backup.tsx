...
import { ArrowRight, BarChart2, Users, Clock, Settings, ShieldCheck, Zap, Menu, X, Check, Star, Award, MessageSquare, FileText, Code, Users as TeamIcon, Mail, MapPin, Phone, Calculator, Building2, ClipboardCheck, DollarSign, Calendar, Target, TrendingUp, Briefcase } from 'lucide-react';
...
const FeatureCard = ({ icon, title, description, index }) => (
  <motion.div
    ...
    className="bg-white p-6 rounded-xl shadow-md hover:shadow-xl transition-all duration-300 border border-gray-100 hover:border-orange-100 group"
  >
...
const testimonials = [
  {
    quote: "DSE has revolutionized our construction project management. Payroll processing that used to take days now takes minutes, and our cost tracking is incredibly accurate.",
    author: "James Mitchell",
    role: "Project Manager, BuildCorp Construction",
    avatar: "/avatars/avatar1.jpg"
  },
  {
    quote: "The attendance tracking and automated payroll features have saved us countless hours. Our employees love the transparency and accuracy of their payslips.",
    author: "Maria Santos",
    role: "HR Director, Premier Engineering",
    avatar: "/avatars/avatar2.jpg"
  },
  {
    quote: "Budget planning and cost control features are game-changers. We can track project profitability in real-time and make informed decisions quickly.",
...
export default function Home() {
  ...
  const features = [
    {
      ...
      description: 'GPS-enabled attendance with real-time monitoring, late arrival detection, and comprehensive reporting for construction sites.'
    },
    {
      icon: <DollarSign className="w-6 h-6" />,
      title: 'Automated Payroll Processing',
      description: 'Calculate salaries automatically based on attendance, apply deductions, and generate professional payslips with one click.'
    },
    {
      icon: <Building2 className="w-6 h-6" />,
      title: 'Project & Cost Management',
      description: 'Manage multiple construction projects, track budgets vs actual costs, and monitor project profitability in real-time.'
    },
    {
      icon: <Users className="w-6 h-6" />,
      title: 'Employee & Trade Management',
      description: 'Organize employees by trades, manage contracts, track performance, and handle multi-project assignments efficiently.'
    },
    {
      icon: <Calculator className="w-6 h-6" />,
      title: 'BOQ & Budget Planning',
      description: 'Create detailed Bills of Quantities, plan project budgets, and track completion progress with accurate cost analysis.'
    },
    {
      icon: <TrendingUp className="w-6 h-6" />,
      title: 'Advanced Analytics & Reports',
      description: 'Generate comprehensive reports on payroll, attendance, project costs, and business performance with exportable data.'
    },
    {
      icon: <ClipboardCheck className="w-6 h-6" />,
      title: 'Compliance & Documentation',
      description: 'Maintain compliance with labor laws, generate audit trails, and keep detailed records for regulatory requirements.'
    },
    {
      icon: <Target className="w-6 h-6" />,
      title: 'Multi-Currency Support',
      description: 'Handle international projects with multi-currency support, exchange rate management, and localized financial reporting.'
    }
  ];
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white">
      {/* Navigation */}
      <nav className={`fixed w-full z-50 transition-all duration-300 ${scrolled ? 'bg-white/95 backdrop-blur-md shadow-lg py-3' : 'bg-white/10 backdrop-blur-sm py-4'}`}>
        <div className="container mx-auto px-6">
          <div className="flex justify-between items-center">
            <div className="flex items-center">
              <div className={`p-2 rounded-xl transition-all duration-300 ${scrolled ? 'bg-orange-50' : 'bg-white/20 backdrop-blur-sm'}`}>
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="absolute inset-0 opacity-30">
          <div className="absolute inset-0" style={{
            backgroundImage: `url("data:image/svg+xml,%3Csvg width='60' height='60' viewBox='0 0 60 60' xmlns='http://www.w3.org/2000/svg'%3E%3Cg fill='none' fill-rule='evenodd'%3E%3Cg fill='%23ffffff' fill-opacity='0.03'%3E%3Cpath d='M0 0h60v60H0z' stroke='%23ffffff' stroke-width='0.5'/%3E%3C/g%3E%3C/g%3E%3C/svg%3E")`
          }}></div>
        </div>
        ...
        >
          <div className="max-w-4xl mx-auto text-center">
            ...
            >
              Revolutionize Construction Management with <span className="text-orange-400">DSE Platform</span>
            </motion.h1>
            ...
            >
              Complete construction project management solution with smart attendance tracking, automated payroll processing, budget planning, and real-time cost control for modern construction companies.
            </motion.p>
